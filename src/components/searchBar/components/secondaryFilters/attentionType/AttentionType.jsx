            ...
            <div className="flex items-center justify-center gap-4 p-3">
                ...
                <div className="flex flex-col items-center">
                    <button
                        ...
                        value="onsite"
                        className={`${attentionType === 'onsite' ? "bg-black text-white" : "border border-black text-black"} flex flex-col items-center justify-center h-20 w-full sm:w-40 md:w-60 xl:w-80 px-4 border border-black rounded-2xl cursor-pointer hover:bg-black group`}
                    >
