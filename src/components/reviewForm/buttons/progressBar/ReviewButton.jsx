        ...
        return (
            ...
            <div className="flex items-center gap-2  sm:drop-shadow-2xl">
                ...
                >
                    {isProcessing ? (
                        <>
                            <span className="max-w-[200px] sm:max-w-[250px] whitespace-nowrap">Redirigiendo...</span>
                        </>
                    ) : (
                        <div className="flex items-center gap-4">
                            ...
                            <span className="max-w-[200px] sm:max-w-[250px] whitespace-nowrap">Escribe una reseña...</span>
                        </div>
                    )}
                </button>
               {/*  <button
