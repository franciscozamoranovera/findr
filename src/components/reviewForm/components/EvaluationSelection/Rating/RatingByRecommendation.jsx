...
export const RatingByRecommendation = ({ recommendationToFamilySelected, onChange }) => {
    ...
    const handleRecommendationClick = (e) => {
        ...
        //onChange("recommendationToFamily", value);
    }
    ...
    return (
            ...
            <div className="flex flex-col items-center justify-center p-3 pb-52">
                ...
                <button
                    className={` ${recommendation === "Excepcional" ? " text-white bg-[#2D2D2D]" : "bg-white"} w-[280px] px-6 py-3 rounded-full  transition-colors m-2 flex flex-row items-center justify-between`}
                    type="button"
                    value="Excepcional"
                ...
                <button
                    className={` ${recommendation === "Muy buena" ? " text-white bg-[#2D2D2D]" : "bg-white"}  w-[280px] px-6 py-3 rounded-full  transition-colors m-2 flex flex-row items-center justify-between`}
                    type="button"
                    value="Muy buena"
                    onClick={handleRecommendationClick}
                >
                ...
                <button
                    className={` ${recommendation === "Cumple" ? " text-white bg-[#2D2D2D]" : "bg-white"} w-[280px]  px-6 py-3 rounded-full  transition-colors m-2 flex flex-row items-center justify-between`}
                    type="button"
                    value="Cumple"
                    onClick={handleRecommendationClick}
                >
                ...
                <button
                    className={` ${recommendation === "Deficiente" ? " text-white bg-[#2D2D2D]" : "bg-white"} w-[280px] px-6 py-3 rounded-full  transition-colors m-2 flex flex-row items-center justify-between`}
                    type="button"
                    value="Deficiente"
                    onClick={handleRecommendationClick}
                >
                ...
                <button
                    className={` ${recommendation === "Pésima" ? "text-white bg-[#2D2D2D]" : "bg-white"} w-[280px] px-6 py-3 rounded-full transition-colors m-2 flex flex-row items-center justify-between`}
                    type="button"
                    value="Pésima"
                    onClick={handleRecommendationClick}
                >
