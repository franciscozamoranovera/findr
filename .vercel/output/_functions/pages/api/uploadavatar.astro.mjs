...
const serviceRoleKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVoZHd1bXl2dnhqbXphdHdrcmh1Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MzcwOTA0NCwiZXhwIjoyMDU5Mjg1MDQ0fQ.85_k8djMQFdDIHRiNBElp3h8P9TiuuyevK99H8_0dPg";
...
async function updateDoctorAvatar({
    doctorId,
    publicUrl
}) {
